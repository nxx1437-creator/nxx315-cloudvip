      ...
      {items.map((item) => {
        ...
        return (
          <button
            ...
            className={`flex h-14 w-full items-center justify-center gap-3 rounded-full border border-slate-300 bg-white px-5 text-sm font-medium text-slate-700 transition ${
              isAnyLoading
