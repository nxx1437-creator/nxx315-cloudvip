...
import {
  ...
  Sparkles,
  HelpCircle,
  // Icons cho sub-cards (phải khai báo hết những gì dùng trong DB)
  KeyRound,
  ShieldCheck,
  Mail,
  RotateCcw,
...
export default function Support() {
  const [view, setView] = useState("home"); // home | help | chat
...
/* ============================================================
   HOME VIEW — grid 2 cột (giống ảnh 1)
   ============================================================ */
...
/* ============================================================
   HELP VIEW — giống TikTok Help Center (ảnh 2)
   ============================================================ */

function HelpView({ category, onBack, onStartChat }) {
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] bg-white pb-24">
      {/* Header */}
      ...
      {/* Sticky button "Trò chuyện với chúng tôi" — giống TikTok */}
