    ...
    <div className="border-b border-gray-100 px-4 pb-3 pt-2">
      <div className="mx-auto max-w-5xl">
        <div className="relative">
          <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 focus-within:bg-white focus-within:ring-2 focus-within:ring-red-100">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-2.5">
        <h3 className="line-clamp-2 text-xs font-black leading-tight text-gray-900">
          {game.name}
        </h3>

        <div className="mt-auto flex w-full items-center justify-center rounded-lg border border-red-500 bg-white py-2 text-[10px] font-black uppercase text-red-500 transition group-hover:bg-red-500 group-hover:text-white">
          Nạp ngay
        </div>
      </div>
    </button>
...
function detectGame(packageId) {
  ...
  if (pid.startsWith('pubg-') || pid.includes('pubg'))
    return 'pubg';
