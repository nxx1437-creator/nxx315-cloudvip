...
// HEADER + SEARCH
// ============================================
function Header({ search, setSearch, navigate }) {
  ...
  const handleKeyDown = (e) => {
    ...
    // Nếu không có thì lấy game đầu tiên khớp
    const matchedGame =
      exactGame ||
      GAMES.find((game) =>
    ...
    <div className="bg-white px-4 py-2.5 border-b border-gray-100">
      <div className="max-w-md mx-auto flex items-center gap-2">
        ...
        <div className="flex-1 relative">
          ...
          {/* SEARCH DROPDOWN */}
          {focused && search.trim() && (
            <div className="absolute z-50 left-0 right-0 top-full mt-2 bg-white rounded-2xl border border-gray-100 shadow-xl overflow-hidden">
                ...
                <div className="py-1">
                  ...
                  {searchResults.map((game) => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2.5 text-left hover:bg-blue-50 active:bg-blue-100 transition"
                    >
      ...
      <div className="rounded-2xl overflow-hidden bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-500 aspect-[16/9] flex items-center justify-center p-4">
        ...
        <div className="text-center text-white">
          ...
          <p className="text-[8px] opacity-80">
            Nạp game nhanh chóng - an toàn - tiện lợi
          </p>
          ...
          <button
            className="mt-2 px-5 py-1 bg-yellow-400 text-blue-900 text-[10px] font-bold rounded-full"
          >
            Khám phá ngay →
          </button>
    ...
    <div className="px-4 pt-4">
      ...
      <div className="grid grid-cols-4 gap-2">
        ...
        {BENEFITS.map(({ id, icon: Icon, label }) => (
          <div
            key={id}
            className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl py-2.5 flex flex-col items-center gap-0.5 border border-blue-100"
          >
          ...
          {games.map((game) => (
            ...
            >
              ...
              <div className="p-1.5 text-center">
                ...
                <p className="text-[8px] font-semibold text-gray-700 truncate">
                  {game.name}
                </p>
