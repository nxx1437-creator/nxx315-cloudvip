        ...
        <div className="mb-5 flex items-center gap-2">
          <div
            className={`h-1.5 flex-1 rounded-full ${
              step >= 1 ? "bg-sky-400" : "bg-white/10"
            }`}
          />
          <div
            className={`h-1.5 flex-1 rounded-full ${
              step >= 2 ? "bg-sky-400" : "bg-white/10"
            }`}
          />
        </div>
        ...
        {renameNotice ? (
          ...
          <>
            ...
            <div className="relative mt-5">
              <User
                size={16}
                className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-sky-300/50"
              />
              <input
                type="text"
                value={username}
          ...
          <>
            ...
            <p className="mt-1 text-sm text-sky-100/60">
              ...
              , trước khi tiếp tục hãy đọc và đồng ý với điều khoản của chúng
              mình.
            </p>
            ...
            <div className="mt-4 max-h-40 overflow-y-auto rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-xs leading-5 text-sky-100/50">
              ...
              của chúng mình. Tên hiển thị của bạn có thể bị hệ thống tự động
              điều chỉnh nếu vi phạm quy định cộng đồng.
            </div>
            ...
            <label className="mt-4 flex items-start gap-2.5 text-sm text-sky-100/70">
              ...
              />
              Tôi đã đọc và đồng ý với Điều khoản sử dụng & Chính sách quyền
              riêng tư.
            </label>
