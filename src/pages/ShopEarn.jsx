      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 flex items-center gap-1.5">
            ...
            <span className="text-xl font-black text-[#18231D]">{currentStreak}</span>
            <span className="text-xs font-bold text-[#7A897F]">ngày</span>
          </div>
        </div>
        <div className="rounded-full bg-[#EFF9E9] px-3 py-1.5 text-[10px] font-black text-[#43A85F]">+{nextReward} ⭐ hôm nay</div>
      </div>
