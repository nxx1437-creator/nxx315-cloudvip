        ...
        <div className="mt-3 space-y-2.5 border-t border-[#F3F4F6] pt-3">
          ...
          <div className="mt-2 space-y-2">
            ...
            <div className="space-y-1.5">
              <RuleItem icon="💵" text="1 sao = 10 VND khi rút tiền" />
              <RuleItem icon="🔄" text="Đổi sang Main coin: 1.000 mkt → 900 main (phí sàn 10%)" />
              <RuleItem icon="🏦" text="Rút bank/ví: phí 20% (rút 100.000 → nhận 80.000 VND)" />
              <RuleItem icon="📌" text="Tối thiểu mỗi lần rút: 10.000 VND" />
              <RuleItem icon="🔀" text="sao mua hàng tách riêng khỏi Main coin — không gộp" />
            </div>
          </div>
        </div>
      )}
