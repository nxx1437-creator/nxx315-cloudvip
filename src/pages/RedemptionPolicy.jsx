...
import { Gift, Coins, ShieldCheck, Clock, AlertCircle, CheckCircle2, XCircle, ArrowLeft } from "lucide-react";

export default function RedemptionPolicy() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-white pb-8 font-[Be_Vietnam_Pro]">
      <style>{`
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        <div className="mb-8 text-center">
          <Link to="/" className="inline-flex items-center gap-1 text-sm text-slate-400 hover:text-sky-600 mb-4">
          ...
          <p className="mt-2 text-sm text-slate-500">Cập nhật lần cuối: 05/09/2026</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Section icon={ShieldCheck} title="2. Điều kiện đổi thưởng">
          ...
          <Section icon={AlertCircle} title="4. Thông tin nhận thưởng">
          ...
          <Section icon={ShieldCheck} title="8. Không được mua bán xu/điểm">
          ...
          <Section icon={CheckCircle2} title="9. Tranh chấp và hỗ trợ">
          ...
          <Section icon={Clock} title="10. Thay đổi phần thưởng">
