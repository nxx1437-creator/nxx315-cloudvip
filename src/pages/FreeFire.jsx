...
function copyText(text) {
  ...
  return (
    <div className="min-h-screen bg-[#fef8f5] pb-40 text-slate-900">
      <TopHeader />
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-red-100 bg-white shadow-sm">
      ...
      <div className="relative h-48 overflow-hidden sm:h-64">
        ...
        {/* Fire badge */}
        <div className="absolute right-4 top-4 flex items-center gap-1.5 rounded-full border border-orange-200 bg-white/95 px-3 py-1.5 shadow-md backdrop-blur-md">
      ...
      <div className="relative -mt-10 px-5 pb-5">
        <div className="flex items-end gap-3.5">
          ...
          <div className="relative shrink-0">
            <div className="absolute -inset-0.5 rounded-2xl bg-gradient-to-br from-orange-400 to-red-500 opacity-60 blur-md" />
            <div className="relative h-20 w-20 overflow-hidden rounded-2xl border-4 border-white bg-orange-50 shadow-lg sm:h-24 sm:w-24">
              <img
                src={FREEFIRE_LOGO}
                alt="Free Fire"
                className="h-full w-full object-cover"
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          <StatPill icon={Zap} label="Tức thì" color="orange" />
          <StatPill icon={ShieldCheck} label="Bảo mật" color="emerald" />
          <StatPill icon={TrendingUp} label="Giá tốt" color="amber" />
        </div>
      </div>
    </div>
  );
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-xs leading-5 text-amber-800">
            Kim Cương sẽ nạp vào UID đã xác nhận. Sai UID không hoàn tiền.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between px-1">
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-orange-400 to-red-500 text-white shadow-md shadow-orange-200">
            <Gem size={16} />
          </div>
          <div>
        ...
        <span className="flex items-center gap-1 rounded-full border border-orange-200 bg-orange-50 px-2.5 py-1 text-[10px] font-bold text-orange-500">
      ...
      <div className="pt-2">
        <button
          ...
          className="group relative flex h-14 w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 text-sm font-black text-white shadow-lg shadow-orange-300/50 transition hover:shadow-orange-400/60 disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none"
        >
  ...
  return (
    <button
      ...
      className={`group relative overflow-hidden rounded-2xl border-2 bg-white p-3 text-left transition-all duration-200 ${
        active
          ? "border-orange-500 bg-orange-50/40 shadow-lg shadow-orange-200/60 -translate-y-1"
          : "border-slate-200 hover:-translate-y-1 hover:border-orange-300 hover:shadow-lg"
      }`}
    >
      {/* Active check */}
      {active && (
        <div className="absolute right-2.5 top-2.5 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-orange-500 text-white shadow-md">
          <CheckCircle2 size={12} strokeWidth={3} />
        </div>
      )}

      {/* Image */}
      <div className="relative mx-auto mb-3 aspect-square w-full max-w-[90px] overflow-hidden rounded-xl border border-slate-100 bg-gradient-to-br from-orange-50 to-amber-50">
        <img
          src={pkg.image}
      ...
      <div className="relative text-center">
        <p className="flex items-center justify-center gap-1 text-base font-black text-slate-900">
          {pkg.diamond.toLocaleString("vi-VN")}
          <Gem size={13} className="text-orange-500" />
        </p>
    ...
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      {selectedPackage && (
        <div className="flex items-center gap-3 rounded-2xl border border-orange-200 bg-orange-50 p-4">
          <div className="h-14 w-14 shrink-0 overflow-hidden rounded-xl border border-orange-100 bg-white">
            <img
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 flex items-center gap-1 text-base font-black text-slate-900">
              {selectedPackage.diamond.toLocaleString("vi-VN")}
              <Gem size={13} className="text-orange-500" />
            </p>
          </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        ...
        <div className="mb-5 flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-orange-400 to-red-500 shadow-md shadow-orange-200">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Nhập UID để nhận Kim Cương
            </p>
          </div>
        </div>

        {/* Label */}
        <label className="mb-2 block text-[11px] font-bold uppercase tracking-widest text-orange-500">
          UID Free Fire
        </label>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-4 pl-11 pr-4 text-sm font-bold text-slate-800 outline-none transition placeholder:font-medium placeholder:text-slate-300 focus:border-orange-400 focus:bg-white focus:ring-4 focus:ring-orange-100"
          />
        </div>
        ...
        <button
          ...
          className="mt-3 inline-flex items-center gap-1.5 text-xs font-semibold text-orange-500 transition hover:text-orange-600 hover:underline"
        >
          <Info size={13} />
        ...
        {/* Info */}
        <div className="mt-5 flex gap-3 rounded-xl border border-orange-100 bg-orange-50/50 p-4">
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="group relative flex h-12 items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-sm font-black text-white shadow-md shadow-orange-200 transition hover:shadow-orange-300/60 disabled:cursor-not-allowed disabled:opacity-40"
          >
            <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
            {creatingOrder ? (
              <>
    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 backdrop-blur-sm sm:items-center sm:p-4">
      <div className="relative flex max-h-[90vh] w-full max-w-md flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl sm:rounded-2xl">
          ...
          {steps.map((item) => (
            <div key={item.step}>
              <div className="mb-2 flex items-center gap-2.5">
                <span className="flex h-7 w-7 items-center justify-center rounded-xl bg-gradient-to-br from-orange-400 to-red-500 text-[11px] font-black text-white shadow-md shadow-orange-200">
                  {item.step}
                </span>
        ...
        <div className="border-t border-slate-100 p-5">
          <button
            onClick={onClose}
            className="h-12 w-full rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-sm font-black text-white shadow-md shadow-orange-200 transition hover:shadow-orange-300/60"
          >
            Đã hiểu
          </button>
        </div>
  ...
  if (!order) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <button
          onClick={onBack}
          className="mt-5 rounded-xl bg-gradient-to-r from-orange-500 to-red-500 px-5 py-3 text-sm font-bold text-white shadow-md shadow-orange-200"
        >
          Quay lại
        </button>
      </div>
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        {/* Amount header */}
        <div className="border-b border-slate-100 bg-gradient-to-br from-orange-50 to-red-50 p-5">
          ...
          <div className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-orange-200 bg-white px-3 py-1.5 text-[11px] font-bold text-slate-600">
            Mã đơn:{" "}
            <span className="font-mono text-orange-500">{order.order_code}</span>
          </div>
        </div>
        ...
        <div className="space-y-4 p-4 sm:p-5">
          ...
          {method === "coin" && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="group relative h-12 w-full overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-sm font-bold text-white shadow-md shadow-orange-200 transition hover:shadow-orange-300/60 disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none"
              >
                <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
            ...
            <div className="space-y-3">
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="rounded-full border border-orange-200 bg-orange-50 px-2.5 py-1 text-[10px] font-bold text-orange-600">
                    {BANK.name}
                  </span>
                </div>
              ...
              {order.status === "paid" ? (
                ...
                <button
                  ...
                  className="group relative h-12 w-full overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-sm font-bold text-white shadow-md shadow-orange-200 transition hover:shadow-orange-300/60"
                >
                  <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
          ...
          {method === "card" && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-1.5 sm:grid-cols-5">
                {cardTypes.map((type) => (
                  ...
                  >
                    ...
                    <p className="mt-0.5 text-xs font-black text-orange-500">
                      {cardDiscounts[type]}%
                    </p>
                  </div>
                ))}
              ...
              {cards.map((card, index) => {
                ...
                return (
                  ...
                  >
                    <div className="mb-3 flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-br from-orange-400 to-red-500 text-[11px] font-black text-white shadow-sm">
                          {index + 1}
                        </span>
                    ...
                    <div className="space-y-3">
                      <div>
                        <label className="mb-1.5 block text-[11px] font-bold uppercase tracking-widest text-orange-500">
                          Loại thẻ
                        </label>
                        <select
                          value={card.type}
                          ...
                          className="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 outline-none transition focus:border-orange-400 focus:ring-2 focus:ring-orange-100"
                        >
                          {cardTypes.map((t) => (
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <input
                            ...
                            className="h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700 outline-none transition placeholder:font-normal placeholder:text-slate-300 focus:border-orange-400 focus:ring-2 focus:ring-orange-100"
                          />
                        </div>
                        <div>
                          <label className="mb-1.5 block text-[11px] font-bold uppercase tracking-widest text-orange-500">
              ...
              <button
                onClick={addCard}
                className="h-11 w-full rounded-xl border-2 border-dashed border-orange-200 text-sm font-bold text-orange-500 transition hover:border-orange-400 hover:bg-orange-50"
              >
                + Thêm thẻ
              </button>
              ...
              <button
                ...
                className="group relative flex h-12 w-full items-center justify-center gap-2 overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 to-red-500 text-sm font-bold text-white shadow-md shadow-orange-200 transition hover:shadow-orange-300/60 disabled:opacity-50"
              >
                <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
                {cardChecking ? (
                  <>
      ...
      <div className="flex min-w-0 items-center gap-2">
        ...
        {(copy || copyValue) && (
          <button
            type="button"
            onClick={handleCopy}
            className="shrink-0 rounded-lg p-1.5 text-slate-400 transition hover:bg-slate-100 hover:text-orange-500"
            title="Sao chép"
          >
            <Copy size={14} />
          </button>
