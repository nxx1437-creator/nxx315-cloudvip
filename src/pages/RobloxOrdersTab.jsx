          ...
          <div className="w-full max-w-md rounded-3xl bg-white p-5 shadow-2xl">
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                rows={4}
                disabled={rejecting}
                className="mt-2 w-full resize-none rounded-2xl border border-slate-200 bg-white p-3 text-sm outline-none transition focus:border-rose-400 focus:ring-2 focus:ring-rose-100 disabled:bg-slate-50"
              />

              <p className="mt-1 text-[11px] text-slate-400">
                Lý do này sẽ được hiển thị cho
                khách hàng trong lịch sử giao dịch.
              </p>
            </div>
